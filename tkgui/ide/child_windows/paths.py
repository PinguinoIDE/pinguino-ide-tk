...
class Paths(Frame):
    ...
    def __init__(self, master=None, main=None):
        ...
        frame8 = Frame(lb8)
        frame8.pack(fill=X, expand=True, side=TOP)

        frame8c = Frame(frame8)
        ...
        frame8l = Frame(frame8)
        frame_text2 = Frame(frame8l)
        frame_text2.pack(side=LEFT)
        Label(frame_text2, text="Libraries:", width=width, anchor="w").pack(side=LEFT)
        ...
        frame32l = Frame(frame32)
        frame_text4 = Frame(frame32l)
        frame_text4.pack(side=LEFT)
        Label(frame_text4, text="Libraries:", width=width, anchor="w").pack(side=LEFT)
        ...
        frame32.pack(fill=X, expand=True, side=TOP)
        ...
        self.dialog_dirs = ((self.label_gcc_bin, "GCC_BIN"),
                            (self.label_sdcc_bin, "SDCC_BIN"),
